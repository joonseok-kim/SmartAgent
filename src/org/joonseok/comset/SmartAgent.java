...
/**
 * A SmartAgent relies on a data model, being capable of re-routing during a trip.
 * 
 * @author Joon-Seok Kim (jkim258 at gmu.edu)
 *
 */
public class SmartAgent extends BaseAgent {
	// All SmartAgent have the same data model
	...
	public SmartAgent(long id, CityMap map) {
		super(id, map);
